...
namespace eval ttk::theme::Arc {
    ...
    ttk::style theme create Arc -parent clam -settings {
        ttk::style configure . \
        ...
        ttk::style layout Vertical.Whitehide.TScrollbar {
            Vertical.Whitehide.Scrollbar.trough -sticky ns -children {
                Vertical.Whitehide.Scrollbar.thumb
            }
        }
        ...
        ttk::style element create Vertical.Whitehide.Scrollbar.trough image $I(trough-scrollbar-vert-whitehide)
        ttk::style element create Vertical.Whitehide.Scrollbar.thumb \
            image [list $I(slider-vert-whitehide) \
                        {pressed !disabled} $I(slider-vert-whitehide) \
                        {active !disabled}  $I(slider-vert-whitehide) \
                        disabled            $I(slider-vert-whitehide) \
            ] -border 6 -sticky ns
